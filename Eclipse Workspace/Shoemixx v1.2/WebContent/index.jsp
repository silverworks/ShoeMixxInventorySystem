...
<head>
	...
	<title>Main Page - shoe-mixx</title>
	...
	<div class="container">
		<div class="login">
		  <header class="login-header"><span class="text">LOGIN</span><span class="loader"></span></header>
		    <input type="text" placeholder="Username" class="login-input" id="username" name="username"/>
		    <!-- <div class="login-input">${branch }</div>  -->
		    <input type="password" placeholder="Password" class="login-input" id="password" name="password"/>
